...
# write.csv(out, "/Cluster_Filespace/Marioni_Group/Danni/LBC_proteins_Jan2021/Model_projections/LBC1921_162_projections.csv", row.names = F)
write.csv(out2, "/Local_Scratch/Danni/GDFBNP/00_Updated_results/Results_scores/projections_LBC_W2_241122.csv", row.names = F)


############################################################################################

## Projections in LBC1936 W3
...
# write.csv(out, "/Cluster_Filespace/Marioni_Group/Danni/LBC_proteins_Jan2021/Model_projections/LBC1921_162_projections.csv", row.names = F)
write.csv(out2, "/Local_Scratch/Danni/GDFBNP/00_Updated_results/Results_scores/projections_LBC_W3_241122.csv", row.names = F)
...
# Filter to wave 1
dat3 <- target %>% filter(WAVE == "4") # 1342 people
...
# Filter to LBC36
dat3  <- dat3 %>% filter(cohort == "LBC36") # 801

# Filter to set one
dat3 <- dat3 %>% filter(set == '1') # 261


# Subset DNAm data to these individuals from W2 and set 1 of LBC36 only 
dat1 <- dat1[,which(colnames(dat1) %in% dat3$Basename)]
...
# write.csv(out, "/Cluster_Filespace/Marioni_Group/Danni/LBC_proteins_Jan2021/Model_projections/LBC1921_162_projections.csv", row.names = F)
write.csv(out2, "/Local_Scratch/Danni/GDFBNP/00_Updated_results/Results_scores/projections_LBC_W2_set1_241122.csv", row.names = F)
...
# write.csv(out, "/Cluster_Filespace/Marioni_Group/Danni/LBC_proteins_Jan2021/Model_projections/LBC1921_162_projections.csv", row.names = F)
write.csv(out2, "/Local_Scratch/Danni/GDFBNP/00_Updated_results/Results_scores/projections_LBC_W2_set2_241122.csv", row.names = F)
...
# write.csv(out, "/Cluster_Filespace/Marioni_Group/Danni/LBC_proteins_Jan2021/Model_projections/LBC1921_162_projections.csv", row.names = F)
write.csv(out2, "/Local_Scratch/Danni/GDFBNP/00_Updated_results/Results_scores/projections_LBC_W3_set1_241122.csv", row.names = F)
...
# write.csv(out, "/Cluster_Filespace/Marioni_Group/Danni/LBC_proteins_Jan2021/Model_projections/LBC1921_162_projections.csv", row.names = F)
write.csv(out2, "/Local_Scratch/Danni/GDFBNP/00_Updated_results/Results_scores/projections_LBC_W3_set2_241122.csv", row.names = F)

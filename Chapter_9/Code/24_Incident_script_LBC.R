...
table(sub2$ConsensusDementiaDiagnosis)
     ...
     #     Dementia               MCI       No dementia       No Dementia
     #          118                13                 7                 2
     # Not dementia Possible dementia
     #           16                 7
...
# I will take forward the 108 diagnoses and assign all those without dementia as controls
# In the next steps, i integrate DOB imputed to July 1936, with censor date as dat of assessment for controls that remained alive
...
d1$YOB <- 1936
d1$MOB <- 07
# d1$y_diff <- 2022 - d1$YOB
# d1$m_diff <- (08 - d1$MOB)/12
# d1$age_censor <- d1$y_diff + d1$m_diff

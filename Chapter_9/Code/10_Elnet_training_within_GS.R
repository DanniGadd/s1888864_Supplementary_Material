...
# GDF EPIC pQTL unadjusted - done
# BNP EPIC pQTL unadjusted - done

# GDF 450k pQTL unadjusted - 
# BNP 450k pQTL unadjusted - 



####################################################################################

### FIRST ANALYSES - pQTL unadjusted
...
### GDF 450k training (pQTL unadjusted 10cv)
...
### GDF EPIC training (pQTL adjusted 10cv)
...
### BNP 450k training (pQTL unadjusted 10cv)
...
### BNP EPIC training (pQTL unadjusted 10cv)
...
# Load pQTL adjusted y files 
BNP_train <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/EpiScores_20k/GDFBNP/00_All_initial_files/02_Relatedness_mapping/W1_BNP_pQTL.csv")
...
GDF_train <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/EpiScores_20k/GDFBNP/00_All_initial_files/02_Relatedness_mapping/W1_GDF15_pQTL.csv")
...
i <- 2
  ...
  # Save coefficients
  write.csv(coefs, file = paste0(location, name_p, "W1W3_train_weights_EPIC_10cv.csv"), row.names = F) 
...
### BNP EPIC training (pQTL adjusted 10cv)
